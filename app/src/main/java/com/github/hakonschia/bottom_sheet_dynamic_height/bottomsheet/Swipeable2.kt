...
fun <T> Modifier.swipeable(
    ...
    resistance: androidx.compose.material.ResistanceConfig? = resistanceConfig(anchors.keys),
...
data class FractionalThreshold(
    ...
    override fun Density.computeThreshold(fromValue: Float, toValue: Float): Float {
        return com.google.android.material.math.MathUtils.lerp(fromValue, toValue, fraction)
    }
}
